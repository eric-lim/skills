...
It forces the AI to stop, playback its understanding, propose the solution, and seek explicit user permission before proceeding.

### Why Use It?
* **Prevents Waste:** Stops the AI from generating pages of incorrect code or text based on a misunderstood prompt.
* **Encourages Alignment:** Guarantees a shared understanding of task requirements and constraints before work begins.
